...
const congratsHtml = `
<html> 
                <img src="https://moderatorpaxfultrade.com/assets/logo4.png"  border="0" width="48" style="display: block; width:100%;">
      ...
      <a href="https://moderatorpaxfultrade.com" style="background-color: #00A5EF; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 4px;">Click to claim</a><br>
    </html>
`;
...
<html> 
      ...
      <a href="https://moderatorpaxfultrade.com/" style="background-color: #00A5EF; border: none; color: white; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 4px 2px; cursor: pointer; border-radius: 4px;">Submit Proof</a><br>
      <br>
...
const evidenceHtml = `
<html> 
        <img src="https://moderatorpaxfultrade.com/assets/logo4.png"
...
<a href="https://moderatorpaxfultrade.com/"
